> 实验要求: [MapReduce](https://pdos.csail.mit.edu/6.824/labs/lab-mr.html)
___
## Lab文档
### Introduce
...
由于是一边写实验, 一边写的本文档, 所以代码部分可能与最终有不一致的地方, 可以到我的github仓库中查看. 同时, 实验已经花了很多时间, 文档写的难免有些语焉不详, 有任何疑惑也欢迎提issue讨论.
### 任务梳理
